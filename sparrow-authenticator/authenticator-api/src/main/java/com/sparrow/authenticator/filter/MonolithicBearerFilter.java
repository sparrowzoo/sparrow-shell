...
public class MonolithicBearerFilter extends AbstractAuthcFilter {
    ...
    public MonolithicBearerFilter(Authenticator authenticator, Boolean mockLoginUser, String tokenKey, Boolean supportTemplate, List<String> excludePatternList, List<String> ajaxPatternList) {
