...
public class FailureDetector {
    ...
    /**
     * Computes the phi value for the member based on the supplied time
     *
     * @param now the current time in milliseconds
     * @return the phi value or null if insufficient data
     * <p>
     * private double convictThreshold = 2.606201185901408; 默认是指数分布
     */
